					...
					<div class="bg-smoke p-4">
						...
						<div class="border-bottom border-top border-light">
							<ul class="text-white text-left">
								<li class="my-2">
									Empieza el juego dando click en el boton empezar.
								</li>
								<li class="my-2">
									Son unas series de juegos  lo cual se desbloquean cuando complete cada uno.
								</li>
								<!--<li class="my-2">
								...
								<li class="my-2">
									Tambien cuando finalice en la parte superior se activa el boton para pasar la siguiente juego
								</li>
							</ul>
						</div>
					</div>
